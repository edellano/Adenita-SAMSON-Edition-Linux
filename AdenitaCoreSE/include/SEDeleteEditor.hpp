...
public :
	...
	SEDeleteEditor();																													///< Builds an editor					
	virtual ~SEDeleteEditor();																											///< Destructs the editor
	...
	SEDeleteEditorGUI*											getPropertyWidget() const;												///< Returns the property widget of the editor
...
SB_REGISTER_TYPE(SEDeleteEditor, "SEDeleteEditor", "592B8158-15E9-B621-0BCB-D7DA210FF149");
SB_DECLARE_BASE_TYPE(SEDeleteEditor, SBGEditor);
